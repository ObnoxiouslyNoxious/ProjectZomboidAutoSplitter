...
<Layout version="1.6.1">
  ...
  <VerticalHeight>234</VerticalHeight>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\robsh\Desktop\ObnoxiouslyNoxious\Tools\LiveSplit\DeadSplit.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="resetMainMenu" type="bool">True</Setting>
          <Setting id="populateSplits" type="bool">True</Setting>
          <Setting id="syncAttemptCount" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
    <Component>
